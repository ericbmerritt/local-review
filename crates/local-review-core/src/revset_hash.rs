//! A content-addressed key for a revset expression.
//!
//! [`RevsetHash`] is a 32-byte BLAKE3 hash of a canonicalized revset string.
//! It provides a stable, compact key for cursor storage that survives
//! whitespace and case variations in the revset expression.
